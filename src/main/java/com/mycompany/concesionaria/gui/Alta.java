...
public class Alta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        labelTtAlta.setText("ALTA DE AUTOMÓVILES");
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        ctrl.agregarAuto(marca, modelo, motor, color, patente, cantidadPuertas);
        JOptionPane oPane = new JOptionPane("Automóvil cargado con exito.");
        oPane.setMessageType(JOptionPane.INFORMATION_MESSAGE);
        JDialog dialogo = oPane.createDialog("Carga de Automovil.");
